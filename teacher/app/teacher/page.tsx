...
import { GraduationCap, BookOpen, ClipboardList, BarChart3, Library, Users, LogOut } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="text-sm font-medium text-gray-700">{userName || 'Teacher'}</span>
