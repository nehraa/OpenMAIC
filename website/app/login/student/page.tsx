    ...
    <div className="min-h-screen bg-dark-base flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-dark-card rounded-2xl border border-dark-line p-8">
          <h1 className="text-2xl font-display font-bold text-white mb-2">Welcome back, Student</h1>
          <p className="text-slate-400 mb-8">Sign in to continue your learning</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            Demo: arjun.mehta@student.edu / demo123
          </p>
        </div>
      </div>
    </div>
