...
export default function IndividualLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Bypass login: set role cookie and redirect to core app (OpenMAIC / Individual B2C mode)
    document.cookie = `aidutech_role=individual; path=/; max-age=${60 * 60 * 24 * 30}`;
    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-background to-muted p-8">
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <h1 className="text-2xl font-bold tracking-tight">Individual Login</h1>
          <p className="text-center text-sm text-muted-foreground">
            Enter your name to access your personal AI learning workspace
          </p>
        </div>
