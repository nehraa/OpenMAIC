...
import { CheckCircle, Circle, Clock, Users, AlertCircle } from 'lucide-react';
...
interface Assignment {
  ...
  slideOpenmaicUrl?: string | null;
  quizOpenmaicUrl?: string | null;
      ...
      <div className="grid gap-6">
        <div className="border rounded-lg p-6">
          ...
          <div className="flex gap-3 mt-4">
            {assignment.slideOpenmaicUrl && (
              <a
                href={assignment.slideOpenmaicUrl}
                target="_blank"
            ...
            {assignment.quizOpenmaicUrl && (
              <a
                href={assignment.quizOpenmaicUrl}
                target="_blank"
                rel="noopener noreferrer"
        ...
        {assignment.recipients && assignment.recipients.length > 0 ? (
          ...
          <div className="border rounded-lg p-6">
            ...
            <p className="text-sm text-gray-500">No recipients assigned to this assignment.</p>
          </div>
        ) : recipientsFailed ? (
          <div className="border rounded-lg p-6">
            <h2 className="font-medium mb-4 flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span>Failed to load recipients</span>
            </div>
          </div>
        ) : null}
